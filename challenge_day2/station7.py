...
Station 7
---------
Fill in `solution_station_7` to implement the algorithm you infer from the station's sample inputs/outputs.
...
def solution_station_7(x):
    """
    TODO: Implement Station 7's algorithm.
    ...
    raise NotImplementedError("Implement station 7 once sample data is provided.")
