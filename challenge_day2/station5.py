...
Station 5
---------
Fill in `solution_station_5` to implement the algorithm you infer from the station's sample inputs/outputs.
...
def solution_station_5(x):
    """
    TODO: Implement Station 5's algorithm.
    ...
    raise NotImplementedError("Implement station 5 once sample data is provided.")
